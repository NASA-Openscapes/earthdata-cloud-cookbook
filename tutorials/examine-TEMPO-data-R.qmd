---
date: last-modified
title: Working with TEMPO data with R and terra
---
...
This notebook retrieves TEMPO data, inspects characteristics of the data such as array shapes and quality flags, and then creates a visualization of total column nitrogen dioxide (NO2) concentrations.
...
# Point of interest: NASA Langley Research Center, Hampton, Virginia (USA)
...
```{r}
# The netCDF driver does not work on non-Linux systems when reading via `/vsi*`,
...
"good" pixels may contain negative column values. For further information about negative values, see the [TEMPO Level 2-3 Trace Gas user guide](https://asdc.larc.nasa.gov/documents/tempo/guide/TEMPO_Level-2-3_trace_gas_clouds_user_guide_V2.1.pdf)
