...
This is the workflow to add individual users one by one. When we have a list of workshop participants, there are quicker ways to add all at once; we'll document that after testing.
