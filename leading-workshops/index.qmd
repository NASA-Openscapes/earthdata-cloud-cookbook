...
-   Check with Luis that the image has what you need
-   Email 2i2c `support at 2i2c.freshdesk.com` (example below) to tell them about the workshop date, start and end times, \# of participants, anticipated level of resources to be used.
