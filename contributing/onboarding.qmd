...
When you join, expect to get access to the following. We'll track this in the `OpenscapesParticipantsList [ nasa-mentors ]` spreadsheet, which is in the Google Drive Folder.
