...
have windows open to view both the GitHub browser and the 2i2c Hub showing
...
Now, switch to the 2i2c Hub to view the Cookbook preview as it would appear
...
-   Now we see a minor issue with capitalization in the
    ...
    -   In GitHub under the "Files changed" tab of the PR, we can add a suggested edit by clicking the "plus"
        button below the line in question. (See minute 17:04 in the
...
including the number of changes requested. Some changes in the middle of a long
