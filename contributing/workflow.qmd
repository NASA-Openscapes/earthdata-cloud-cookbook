...
proposing to add, request their review (TODO: add screenshot to request
reviewer).

The following notes are adapted from a coworking session in which Amy
Steiker and Julie Lowndes reviewed [a pull
...
*TODO: add video w Stef & Julie on mechanics of reviewing a pull
request.*

In reviewing a pull request with lots of changes, it can be helpful to
have windows open to view both the GitHub browser and the Hub showing
the Cookbook preview.
...
Now, switch to the Hub to view the Cookbook preview as it would appear
...
-   Now we see a minor issue with capitalization in the
    ...
    -   In GitHub, we can add a suggested edit by clicking the "plus"
        button below the line in question. See (See \~minute 17:24 in
        the
        [video](https://drive.google.com/file/d/1LG82x2csIKqNx7KewkkLlMfFFKl1ioRW/)
        for the mechanics of this. Suggesting specific commits can speed
        the contributor's workflow compared with trying to describe what
