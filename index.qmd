...
**Tip: use the _earthaccess_ python library to access NASA earth data**. [earthaccess](https://earthaccess.readthedocs.io/en/latest/) is a Python library to access NASA earthdata locally or in the cloud. To learn more, see this [tech spotlight](), the [NASA Earthdata blog post](https://www.earthdata.nasa.gov/learn/blog/earthaccess), and these [how-to's](how-tos/find-data/find-python.html) and [tutorials](tutorials/). 
