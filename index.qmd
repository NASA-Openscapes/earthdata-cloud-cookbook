...
**Use the [earthaccess](https://earthaccess.readthedocs.io/en/latest/) python library to access NASA earth data**

[earthaccess](https://earthaccess.readthedocs.io/en/latest/) is a Python library to access NASA earthdata locally or in the cloud. To learn more, see this [tech spotlight](), the [NASA Earthdata blog post](https://www.earthdata.nasa.gov/learn/blog/earthaccess), and these [how-to's](how-tos/find-data/find-python.html) and [tutorials](tutorials)).

Looking for R and MATLAB help? See the earthdatalogin R package [documentation](https://boettiger-lab.github.io/earthdatalogin/) and [tutorials](how-tos/find-data/find-r.html) in this cookbook, and the [MATLAB tutorial](tutorials/matlab.qmd).
