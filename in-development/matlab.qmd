...
## Launch Matlab in 2i2c JupyerHub
...
![Select Matlab from the Server Options and press Start](images/matlab-server.png){fig-alt="screenshot of the JupyterHub launch page that has Python, R, and Matlab as selections, and Matlab is selected." fig-align="center" width="338"}

![Launch Matlab from the JupyterHub interface by double-clicking](images/matlab-launch.png){fig-alt="screenshot of JupyterHub interface launch page, with Matlab kernel options" fig-align="center" width="467"}

![Enter your MATLAB login information](images/matlab-login.png){fig-alt="screenshot of MATLAB login page prompting your email address" fig-align="center" width="525"}

## **Access Single NASA EarthData L2 NetCDF**
