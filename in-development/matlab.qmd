...
The latter allows you to access advanced HDF5 functionality and bypasses I/O overhead in the high-level	interface, but has a substantially higher learning curve unless already familiar with the HDF5 C API.
